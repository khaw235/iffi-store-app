...
class Cart(models.Model):
    ...
    subtotal = models.DecimalField(default = 00.00, max_digits = 100, decimal_places = 2)
...
m2m_changed.connect(m2m_changed_cart_receiver, sender = Cart.two_piece_suits.through)
